...
function Bank(bankName,location,ifscCode,branchCode){
    ...
    let yesBank=new Bank("Yes Bank","Baner,Pune","YESB0000008","000008")
    ...
    let sbiBank=new Bank("SBI Bank","Kalyan","SBIN0016517","016517")
    ...
    let axisBank=new Bank("Axis Bank","RG road,Bangluru","UTIB000009","000009")
    ...
    console.log(`-----Prototype-adding new data member using prototype------`);
